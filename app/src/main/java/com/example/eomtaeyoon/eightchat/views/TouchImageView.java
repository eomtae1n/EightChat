...
public class TouchImageView extends android.support.v7.widget.AppCompatImageView implements View.OnTouchListener {
    // 디버깅 정보
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mode == DRAG) {
                    ...
                    params.leftMargin = (int) event.getX() - (int) start.x;
                    params.topMargin = (int) event.getY() - (int) start.y;
